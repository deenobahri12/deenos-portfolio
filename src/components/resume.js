        ...
        return(
          <Grid>
              <Cell className="resume-left-col" col={4}>
                  ...
                  <hr/>  
                  <h4><a target='_blank' href='https://drive.google.com/file/d/14lRUMgjjpobUg8xLoFvm6Ok68iyDSmT2/view?usp=sharing'><img src="https://img.icons8.com/cute-clipart/66/000000/file.png"/>Resume (PDF)</a></h4>
                  <hr/>
            ...
            <Experience jobName={<h4>Software Engineer: 2019 to Present-</h4>}/>
             ...
             <p className='descrip'>
               ...
               This role was centered in the Product-delivery department and I completed large projects from beginning to end in the business intelligence industry. 
             </p>
